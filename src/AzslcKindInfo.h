...
namespace AZ::ShaderCompiler
{
    ...
    struct SRGSemanticInfo
    {
        ...
        // If set, resources contained in associated SRGs are bound by indirection
        bool m_indirect;
    };
    ...
    struct SRGInfo
    {
        ...
        // If set, the SRG semantic associated with this SRG access resource through a layer
        // of indirection.
